  ...
  return (
    ...
    <div className="box-container">
        <div className="box">
            ...
            <p className="mb-2"  style={{textTransform: 'lowercase'}}><i className="fa fa-envelope me-3"></i>vihari@iiits.in</p>
            <div className="share">
                <Link to="https://www.facebook.com" ><i className="fab fa-facebook-f mx-2"></i></Link>
                <Link to="https://www.instagram.com" ><i className="fab fa-instagram mx-2"></i></Link>
                <Link to="https://in.linkedin.com" ><i className="fab fa-linkedin mx-2"></i></Link>
            </div>
        </div>
        <div className="box">
            <h3>quick links</h3>
